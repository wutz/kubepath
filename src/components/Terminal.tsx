...
export function Terminal({
  ...
  return (
    /* 深色面用 ink（DESIGN.md code-editor-mockup），内部分层靠黑色叠加 —— 与 storpath 一致 */
    <section className="bg-ink shadow-float my-6 overflow-hidden rounded-md">
      ...
      */}
      ...
      >
        ...
        <div className="text-brand-500 sticky left-0 flex items-center gap-2">
